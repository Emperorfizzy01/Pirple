...
app.loadAccountEditPage = function(){
  ...
  var phoneNumber = typeof(app.config.sessionToken.phoneNumber) == 'string' ? app.config.sessionToken.phoneNumber : false;
  if(phoneNumber){
    // Fetch the user data
    var queryStringObject = {
    ...
    app.client.request(undefined,'api/users','GET',queryStringObject,undefined,function(statusCode,responsePayload){
      if(statusCode == 200){
        ...
        for(var i = 0; i < hiddenPhoneInputs.length; i++){
            hiddenPhoneInputs[i].value = responsePayload.phoneNumber;
        }
